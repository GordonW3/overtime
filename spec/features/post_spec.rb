...
describe 'navigate' do
	...
	describe 'index' do
		...
		it 'has a scope so that only post creaters can see their posts' do
			other_user = User.create(first_name: "non", last_name: "Authorised", email: "test@testy2.com", password: "123456", password_confirmation: "123456", phone: "1112223333" )
 	...
 	describe 'new' do
 		it 'has a link from the homepage' do
 			employee = Employee.create(first_name: "Employee", last_name: "Authorised", email: "employee@example.com", password: "123456", password_confirmation: "123456", phone: "1112223333" )
	...
	describe 'creation'	do
		...
		it 'can be created from page' do
